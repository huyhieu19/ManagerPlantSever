...
namespace ManagerServer.Common.Mapper
{
    ...
    {
        public static DataProcessingDisplayModel ToDataModel(this DataProcessingEntity entity)
        {
        ...
        public static DataSensorDisplayModel ToDataSensorModel(this DataProcessingEntity entity)
        {
